                  ...
                  child: Stack(
                    children: [
                      DecoratedBox(
                        ...
                        child: widget.notification.image.startsWith('http')
                            ? CircleAvatar(
                          backgroundImage:
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: widget.notification.type == 'friend' || widget.notification.type == 'accept'
                                  ? Colors.blue
                                  : widget.notification.type == 'comment'
                                  ? Colors.green[400]
                                  : widget.notification.type == 'page'
                          ...
                          child: (widget.notification.type == 'memory')
                            ...
                            size: 30,
                              ...
                              : (widget.notification.type == 'friend' || widget.notification.type == 'accept')
                              ? const Icon(
                            Icons.person_rounded,
                            color: Colors.white,
                            size: 22,
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () {
                                    UserData.getStringData('token').then((
                                        token) {
                                      Map<String, dynamic> data = {
                                        'user_id': widget.notification.id,
                                        'is_accept': '1'
                                      };
                                      print(data);
