            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Text(
                    'Hoàn tất đăng ký',
                    style: TextStyle(color: Color.fromARGB(255, 39, 41, 47), fontSize: 21, fontWeight: FontWeight.w600),
                  ),
                ),
                RichText(
                  ...
                  text: const TextSpan(
                      children: <TextSpan>[
                        TextSpan(text: 'Bằng cách nhấn vào Đăng ký, bạn đồng ý với', style: TextStyle(color: Color.fromARGB(255, 125, 122, 122))),
                        TextSpan(text: ' Điều khoản, Chính sách dữ liệu', style: TextStyle(color: Colors.blue)),
                        TextSpan(text: ' và', style: TextStyle(color: Color.fromARGB(255, 125, 122, 122))),
                        TextSpan(text: ' Chính sách cookie', style: TextStyle(color: Colors.blue)),
                        TextSpan(
                            text:
